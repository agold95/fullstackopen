describe('Blog app', function () {
  ...
  describe('When logged in', function () {
    beforeEach(function () {
      ...
      cy.createBlog({ title: 'first blog', author: 'A Guy', url: 'www.stuff.com', likes: 1 })
      cy.createBlog({ title: 'second blog', author: 'Another Guy', url: 'www.stuff2.com', likes: 2 })
    })

    it('A blog can be created', function () {
      cy.createBlog({ title: 'created blog', author: 'A dude Guy', url: 'www.who.com' })
